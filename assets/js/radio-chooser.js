...
Vue.component('chooser', {
  ...
  methods: {
    ...
    filterOptions: function(event) {
      ...
      choice = "no";
      if ($("#" + question_id).is(":checked")) {
        choice = "yes";
      }
      console.log(choice)
      
      // Update choices
      this.choices[question_id] = Array(choice);
          ...
          if (question.unique_id in tool) {
            ...
            if ((options.length == 1) && (options[0] == "")) {
              ...
              $.each(values, function(ii, value) {
                ...
                // Special case, unsure or NO means "I'll accept all, it doesn't make a difference, leave as current value
                if ((value == "not sure") || (value == "--") || (value == "no")) {
